...
var Switch = function (_a) {
    var name = _a.name, validate = _a.validate, fast = _a.fast, onChange = _a.onChange, checked = _a.checked, restProps = tslib_1.__rest(_a, ["name", "validate", "fast", "onChange", "checked"]);
